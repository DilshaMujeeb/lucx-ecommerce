...
router.get('/view-order-products/:id',authentication.adminAuth,adminControl.getorderDetails)

router.post('/order-status/:id',authentication.adminAuth,adminControl.postOrderDetails)
...
router.get("/coupon-view", authentication.adminAuth, adminControl.getCouponView);
